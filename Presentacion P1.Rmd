...
de estudiante. Es necesario conseguir información de estudiantes de otras
universidades para lograr universalizar nuestros resultados.

### <b style = 'color : #63B8FF;'> **Importancia** </b>

Los estudiantes universitarios de UTEC necesitan aprobar varios cursos a lo
largo de su vida universitaria para lograr obtener su título.
Además de esto, obtener buenas notas—y buenos aprendizajes—mejorará sus
prospectos una vez graduados. A pesar de esto, muchas veces se encuentran
desorientados y sin guías que seguir; no saben cuál es el perfil de los mejores
estudiantes y cuáles de sus características podrían ser causantes de sus buenos
resultados.

### <b style = 'color : #63B8FF;'>**Relevancia**</b>

Describir los perfiles de estudiantes, tomaremos en cuenta sus hábitos de
estudio, horas de sueño, tiempo en llegar a la universidad, nivel
socioeconómico, entre otras. También veremos si alguna de estas características
están relacionadas con sus notas obtenidas.

### <b style = 'color : #63B8FF;'> **Factibilidad** </b>

La recolección de datos la podemos
automatizar usando herramientas digitales (e.g., Google forms) y de esta forma
los alumnos pueden rellenar sus respuestas sin necesidad de un grupo
encuestador. Estas herramientas son gratis y fáciles de usar y los
alumnos ya están acostumbrados a ellas. Asimismo, contamos con los correos
electrónico de todos los estudiantes de UTEC, por lo que podremos contactarlos
fácilmente.

Contamos con una forma de recolectar datos y un medio por el que contactar a los
estudiantes. Por tanto, creemos que el estudio es factible.

!["Diagrama de Gantt"](gantt.jpg){width='500px'}

### <b style = 'color : #63B8FF;'> **Interés del Público** </b>

Todos los estudiantes están interesados en obtener buenas calificaciones y
facilitar su comprensión del material. Al finalizar el estudio podremos
dar recomendaciones de rutinas, métodos de estudio y características que podrían
ser imitadas por estudiantes que busquen mejorar su desempeño académico.

### <b style = 'color : #63B8FF;'> **1 Objetivos** </b>

Describir las relaciones entre perfiles de estudiantes y sus desempeño académicos
